...
<?php
	   $regnumber=$_POST['regnumber'];
		...
		if($flag==0)
		{
			echo "the registration number does not exist";exit;
		}
...
echo $body             = "hello ".$name. " Your password is ".$password;					//Message Body..............................
